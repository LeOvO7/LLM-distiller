...
**NOTE!**：The project is still undergoing optimization; these results are not final.
...
A bonus **Reverse Distillation** experiment showed that injecting the student's outputs as few-shot examples into GPT-4o-mini raised its Floq hit rate from 5.5% → 33.2%, demonstrating bidirectional knowledge transfer.
...
[![Contributors]([https://img.shields.io/github/contributors/owner/repo.svg)](https://github.com/owner/repo/graphs/contributors](https://github.com/LeOvO7/LLM-distiller/graphs/contributors))
